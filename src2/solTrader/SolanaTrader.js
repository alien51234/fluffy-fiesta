...
class SolanaTrader {
    constructor(endpoint, senderPrivateKeyBase64) {
        ...
        this.tradeExecutor = new TradeExecutor_1.default(endpoint, senderPrivateKeyBase64);
        this.solTransfer = new SOLTransfer_1.default(endpoint, senderPrivateKeyBase64);
        this.tokenSender = new TokenSender_1.default(endpoint, senderPrivateKeyBase64);
    }
    ...
    newOrder(tokenMintAddress, side, realAmount, slippageRate) {
        return __awaiter(this, void 0, void 0, function* () {
            if (side === this.long) {
                return yield this.tradeExecutor.executeTrade(this.solAddress, tokenMintAddress, realAmount, slippageRate);
            }
            else {
                return yield this.tradeExecutor.executeTrade(tokenMintAddress, this.solAddress, realAmount, slippageRate);
            }
        });
    }
