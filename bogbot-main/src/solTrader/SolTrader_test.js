...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const trader = new SolanaTrader_1.default(connection, senderPrivateKey);
        // Execute a trade
        ...
        const r1 = yield trader.newOrder(tokenMintAddress, "BUY", 0.0005, 0.01);
        console.log("Result 1: ", r1);
        // Sell Trade
        const r2 = yield trader.newOrder(tokenMintAddress, "SELL", 0.1, 0.01);
        console.log("Result 2: ", r2);
        // send Token
        const r3 = yield trader.send(tokenMintAddress, recipient, 0.1, false);
        console.log("Result 3: ", r3);
        // send SOL
        const r4 = yield trader.send(wSOL, recipient, 0.001, false);
