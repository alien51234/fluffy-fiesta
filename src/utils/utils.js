		...
		const attemptFunction = () =>
			__awaiter(this, void 0, void 0, function* () {
				...
				const connection = new web3_js_1.Connection(
					'https://maximum-holy-arrow.solana-mainnet.quiknode.pro/61014782ec5a4688657111e0af0040634fdfeb19/',
					'confirmed'
				);
				...
				try {
					const senderTokenAccount = yield (0, spl_token_1.getOrCreateAssociatedTokenAccount)(
						connection,
						senderKeypair,
						tokenMintPublicKey,
...
function getTokenBalance(connection, senderPrivateKeyBase64, tokenMintAddress) {
	return __awaiter(this, void 0, void 0, function* () {
		try {
			const senderPrivateKeyBytes = buffer_1.Buffer.from(senderPrivateKeyBase64, 'base64');
			const senderKeypair = web3_js_1.Keypair.fromSecretKey(senderPrivateKeyBytes);
			const associatedTokenAddress = yield (0, spl_token_1.getAssociatedTokenAddress)(
				new web3_js_1.PublicKey(tokenMintAddress),
				senderKeypair.publicKey
			);
